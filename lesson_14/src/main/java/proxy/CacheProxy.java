...
public class CacheProxy implements InvocationHandler {
    ...
    private static final String CACHE_FILE_ROOT = System.getProperty("user.dir") + "/lesson_8/src/main/resources/";
    private static final String FORMAT_OF_CACHE_FILE = ".ser";
    private static final String ZIP_FORMAT_OF_CACHE_FILE = ".zip";
    private final Object delegate;
    private final Map<List<Object>, Object> cacheInMemory = new ConcurrentHashMap<>();
    private final Map<List<Object>, Object> cacheInFile = new ConcurrentHashMap<>();
    private Cache annotation;
    private File temporaryCacheFile;
    ...
    private Object cacheInvoke(Method method, Object[] args) {
        ...
        File cacheFile = getFile(method, FORMAT_OF_CACHE_FILE);
        loadCacheFromFileHandler(cacheFile);

        File zipFile = getFile(method, ZIP_FORMAT_OF_CACHE_FILE);
    ...
    private File getFile(Method method, String formatOfFile) {
        ...
        File file = new File(CACHE_FILE_ROOT + filename + formatOfFile);
        return file;
    }
            ...
            if (file.exists()) {
                try {
                    temporaryCacheFile = new File (file.getAbsolutePath().substring(0,file.getAbsolutePath().lastIndexOf("."))
                            + "Temporary" + FORMAT_OF_CACHE_FILE);
    ...
    private void zipCacheFIle(Method method, File cacheFile) {
        ...
        File zipOfCacheFile = new File(CACHE_FILE_ROOT + getFileName(method) + ZIP_FORMAT_OF_CACHE_FILE);
        try {
